...
public class TestExercise {
    ...
    public void testHoraEsValidaAmbMassaHores() {
        assertFalse("Les hores no són vàlides", Hora.esValida(24, 2, 3));
    }

    @Test
    public void testHoraEsValidaAmbMassaPoquesHores() {
        assertFalse("Les hores no són vàlides", Hora.esValida(-1, 2, 3));
    }

    @Test
    public void testHoraEsValidaAmbMassaMinuts() {
        assertFalse("Els minuts no són vàlids", Hora.esValida(1, 60, 3));
    }

    @Test
    public void testHoraEsValidaAmbMassaPocsMinuts() {
        assertFalse("Els minuts no són vàlids", Hora.esValida(1, -1, 3));
    }

    @Test
    public void testHoraEsValidaAmbMassaSegons() {
        assertFalse("Els segons no són vàlids", Hora.esValida(1, 2, 60));
    }

    @Test
    public void testHoraEsValidaAmbMassaPocsSegons() {
        assertFalse("Els segons no són vàlids", Hora.esValida(1, 2, -1));
    }
    ...
    public void testDuplicaHoraResultatAmbMateixosValors() {
        ...
        assertEquals("Respecte a les hores", hora.getHores(), duplicada.getHores());
        assertEquals("Respecte als minuts", hora.getMinuts(), duplicada.getMinuts());
        assertEquals("Respecte als segons", hora.getSegons(), duplicada.getSegons());
    }
    ...
    public void testDuplicaHoraResultatEsUnaAltraInstancia() {
        ...
        assertFalse("L'hora duplicada no ha de ser la mateixa instància", hora == duplicada);
    }
